...
function workerid_check() {
    ...
    if (workerid == null) {
        ...
        $("#workerid_info").html("Your MTurk Worker ID was identified as <b>" + window.workerid + "</b>. You will receive a corresponding completion code (password) at the end of the experiment.");
